...
OBJS+= src/enemies/enemy.o src/enemies/classicEnemy.o src/enemies/bigEnemy.o src/enemies/healerEnemy.o src/tower/classicTower.o src/tower/slowingTower.o src/tower/explosiveTower.o
